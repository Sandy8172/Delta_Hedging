...
const Factor_DeltaCard = ({ delta, factor }) => {
  ...
  return (
    <div className="items-center justify-between gap-2 px-1 border border-gray-300 rounded-lg shadow-lg dark:shadow-gray-800 hover:bg-gray-100  dark:border-gray-700 dark:hover:bg-gray-700 ">
